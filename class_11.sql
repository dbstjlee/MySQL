...
-- 문제 2인 회원의 전화번호를 010-2222-2222로 수정해주세요.
update member set phone = '010-2222-2222' where id = 2;

-- 문제 id가 5인 회원의 이메일과 주소를 'a@naver.com', '부산시 진구'로 수정
update member set email = 'a@naver.com',
address ='부산시 진구'
where id = 5;

-- id 1번 회원의 email 을 'a@naver.com'으로 수정해보세요.
update member set emil = 'a@naver.com'
where id = 1;
-- email 컬럼에 먼저 들어가 있어서 업데이트 불가
